...
current_employees = pd.read_excel(r"C:\Users\lando\Desktop\analyse pi\emp_data.xlsx")
external_candidates_cv = pd.read_csv(r"C:\Users\lando\Desktop\analyse pi\cv\cv_data.csv")
external_candidates_linkedin = pd.read_csv(r"C:\Users\lando\Desktop\analyse pi\donnees_employes_organisees.csv")
